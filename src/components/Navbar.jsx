...
import perfilImage from "../assets/userimage.png";


const Navbar = ({ menuItems }) => {
    //para manejar los menus flotantes
        ...
        <>
            <nav class="bg-white border-gray-200 dark:bg-gray-900">
                <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                    ...
                    <div class="flex flex-row md:flex-col md:items-end  md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
                        <button
                            type="button"
                            class="flex items-center text-sm md:bg-gray-800 rounded-full md:me-0 focus:ring-4 focus:ring-gray-300 dark:focus:ring-gray-600"
                        ...
                        {/* Menú desplegable (fuera del contenedor de la barra de navegación) */}
                        {pictureAbierto && (
                    ...
                    {/* aqui aparecen los botones centrales */}
                    <div
